...
class UserSettings {
  ...
  UserSettings({
    ...
    this._editorTheme,
    this._accentColor,
    this._panelVisibility,
    this._panelSizes,
    this._uiScale,
    this._animationEnabled,
    this._rememberLayout,
    this._tabSize,
    this._showLineNumbers,
    this._wordWrap,
    this._showMinimap,
    this._autoSave,
    this._bracketMatching,
    this._showHiddenFiles,
    this._autoRefreshExplorer,
    this._realTimeInspector,
    this._restrictedExecution,
    this._networkAccess,
    this._telemetry,
    this._kernelAddress,
    this._connectionTimeout,
    this._executionTimeout,
    this._showWhitespace,
    this._enableAutocomplete,
    this._defaultProjectPath,
    this._plotColormap,
    this._syntaxHighlightTheme,
    this._showToolbar,
    this._showStatusBar,
  });
